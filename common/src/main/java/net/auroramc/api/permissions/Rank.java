...
public enum Rank {
    ...
    ELITE(1, "Elite", "Elite", TextComponent.fromLegacyText("§b§l«ELITE»\n \n" +
    ...
    MASTER(2, "Master", "Master", TextComponent.fromLegacyText("§d§l«MASTER»\n \n" +
    ...
    YOUTUBE(5, "YouTube", "YouTube", TextComponent.fromLegacyText("§6§l«YOUTUBE»\n\n" +
    ...
    STREAMER(6, "Streamer", "Stream", TextComponent.fromLegacyText("§5§l«STREAMER»\n\n" +
    ...
    BUILDER(7, "Builder", "Builder", TextComponent.fromLegacyText("§a§l«BUILDER»\n \n" +
    ...
    BUILD_TEAM_MANAGEMENT(8, "Build Team Management", "BTM", TextComponent.fromLegacyText("§a§l«BTM»\n \n" +
    ...
    JUNIOR_MODERATOR(9, "Junior Moderator", "Jr.Mod", TextComponent.fromLegacyText("§9«JUNIOR MOD»\n \n" +
    ...
    MODERATOR(10, "Moderator", "Mod", TextComponent.fromLegacyText("§9§l«MOD»\n \n" +
    ...
    ROBOT(8001, "Robot", "Robot", TextComponent.fromLegacyText("§4§l«ROBOT»\n \n" +
    ...
    ADMIN(11, "Administrator", "Admin", TextComponent.fromLegacyText("§4§l«ADMIN»\n \n" +
    ...
    DEVELOPER(12, "Developer", "Dev", TextComponent.fromLegacyText("§a«DEV»\n \n" +
    ...
    SENIOR_DEVELOPER(13, "Senior Developer", "Sr.Dev", TextComponent.fromLegacyText("§4§l«SR.DEV»\n \n" +
    ...
    PARTNER(14, "Partner", "Partner", TextComponent.fromLegacyText("§c§l«PARTNER»\n\n" +
    ...
    OWNER(9001, "Owner", "Owner", TextComponent.fromLegacyText("§4§l«OWNER»\n \n" +
