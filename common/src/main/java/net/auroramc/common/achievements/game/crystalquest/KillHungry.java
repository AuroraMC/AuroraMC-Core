...
public class KillHungry extends TieredAcheivement {
    ...
    public KillHungry() {
        super(65, "Kill Hungry", "Kill %s Enemies in Crystal Quest.", new Reward("None", 0, 0, 0, Collections.emptyMap(), Collections.emptyList()), true, false, AchievementCategory.GAME, 1);
