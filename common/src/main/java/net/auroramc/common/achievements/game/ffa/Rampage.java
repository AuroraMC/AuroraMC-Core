...
public class Rampage extends TieredAcheivement {
    ...
    public Rampage() {
        super(145, "Rampage", "Kill %s amount of players in FFA.", new Reward("None", 0, 0, 0, Collections.emptyMap(), Collections.emptyList()), true, false, AchievementCategory.GAME);
