...
public class Smokin extends TieredAcheivement {
    ...
    public Smokin() {
        super(168, "SMOKIN'", "Die to the Hot Potato %s times.", new Reward("None", 0, 0, 0, Collections.emptyMap(), Collections.emptyList()), true, false, AchievementCategory.GAME, 101);
