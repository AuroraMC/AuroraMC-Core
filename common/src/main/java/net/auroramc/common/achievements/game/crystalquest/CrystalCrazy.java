...
public class CrystalCrazy extends TieredAcheivement {
    ...
    public CrystalCrazy() {
        super(62, "Crystal Crazy", "Return %s Enemy Crystals to your team's base.", new Reward("None", 0, 0, 0, Collections.emptyMap(), Collections.emptyList()), true, false, AchievementCategory.GAME);
