...
public class CookieMonsterLovesCookies extends TieredAcheivement {
    ...
    public CookieMonsterLovesCookies() {
        super(73, "COOKIE MONSTER LOVES COOKIES", "Eat %s Instant Cookies.", new Reward("None", 0, 0, 0, Collections.emptyMap(), Collections.emptyList()), true, false, AchievementCategory.GAME);
