...
public class IPLookupPlayer extends GUI {
    ...
    public IPLookupPlayer(PlayerProfile playerProfile) {
        ...
        this.setItem(1, 6, new GUIItem(Material.BOOK_AND_QUILL, "&3&lAlternate Accounts", 1, String.format(";&r&fTheir IP Profiles are;&r&fshared with **%s** other accounts.;;&r&fMost recent alts:;**%s**", playerProfile.getSharedAccounts(), String.join("**;**", playerProfile.getMostRecentAlts()))));
