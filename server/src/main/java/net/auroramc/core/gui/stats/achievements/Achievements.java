...
public class Achievements extends GUI {
    ...
    public Achievements(AuroraMCServerPlayer player, PlayerStatistics targetStatistics, String target) {
        ...
        this.setItem(0, 4, new GUIItem(Material.SKULL_ITEM, String.format("&3&l%s's Achievements", target), 1, String.format(";&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**", targetStatistics.getAchievementsGained().size(), totalAchievements), (short) 3, false, target));
        ...
        this.setItem(2, 2, new GUIItem(Material.SIGN, "&3&lGeneral Achievements", 1, String.format("&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**", targetStatistics.getAchievementsGained().keySet().stream().filter(achievement -> achievement.getCategory() == Achievement.AchievementCategory.GENERAL).count(), totalGeneralAchievements)));
        this.setItem(2, 3, new GUIItem(Material.SKULL_ITEM, "&d&lFriends Achievements", 1, String.format("&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**", targetStatistics.getAchievementsGained().keySet().stream().filter(achievement -> achievement.getCategory() == Achievement.AchievementCategory.FRIENDS).count(), totalFriendsAchievements)));
        this.setItem(2, 4, new GUIItem(Material.FIREWORK, "&6&lParty Achievements", 1, String.format("&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**", targetStatistics.getAchievementsGained().keySet().stream().filter(achievement -> achievement.getCategory() == Achievement.AchievementCategory.PARTY).count(), totalPartyAchievements)));
        this.setItem(2, 5, new GUIItem(Material.WATCH, "&c&lTime Achievements", 1, String.format("&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**", targetStatistics.getAchievementsGained().keySet().stream().filter(achievement -> achievement.getCategory() == Achievement.AchievementCategory.TIME).count(), totalTimeAchievements)));
        this.setItem(2, 6, new GUIItem(Material.RED_ROSE, "&a&lLoyalty Achievements", 1, String.format("&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**", targetStatistics.getAchievementsGained().keySet().stream().filter(achievement -> achievement.getCategory() == Achievement.AchievementCategory.LOYALTY).count(), totalLoyaltyAchievements)));
        this.setItem(3, 3, new GUIItem(Material.EXP_BOTTLE, "&b&lExperience Achievements", 1, String.format("&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**", targetStatistics.getAchievementsGained().keySet().stream().filter(achievement -> achievement.getCategory() == Achievement.AchievementCategory.EXPERIENCE).count(), totalExperienceAchievements)));
