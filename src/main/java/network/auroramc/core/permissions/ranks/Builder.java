...
public final class Builder extends Rank {
    ...
    public Builder() {
        super(7, "Builder", "Builder", "&a«BUILDER»\n \n" +
                        ...
                        "&fmaps you can find on the network!", null, 'a', 'f', 'a', 'f', false, new ArrayList<>(Collections.singletonList(AuroraMCAPI.getRanks().get(2))), new ArrayList<>(Collections.singletonList(AuroraMCAPI.getPermissions().get("build"))), CONTENT_CREATOR, Color.fromRGB(85, 255, 85));
    }
}
