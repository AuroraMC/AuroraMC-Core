...
public class HalfWayThere extends KillMessage {
    ...
    public HalfWayThere() {
        super(501, "&cHalf Way There", "&cHalf Way There", "WOOOAAAAHHHH WE'RE HALF WAY THERE, WOOOOOOAAAAAAAHHHHHHH LIVING ON A PRAYER", UnlockMode.CRATE, -1, Collections.emptyList(), Collections.emptyList(), "Can be found in crates.", true, Material.BOOK, (short)0, Rarity.EPIC);
    }
