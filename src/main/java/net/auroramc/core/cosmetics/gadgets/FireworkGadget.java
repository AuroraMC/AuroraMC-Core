...
public class FireworkGadget extends Gadget {
    public FireworkGadget() {
        super(800, AuroraMCAPI.getFormatter().rainbow("Firework Gadget"), AuroraMCAPI.getFormatter().rainbow("Firework Gadget"), "&oYou're actually giving us permission to do this? &7That is correct, Longbottom. &oTo blow it up? Boom? &7BOOM!", UnlockMode.STORE_PURCHASE, -1, Collections.emptyList(), Collections.emptyList(),"Purchase the Grand Celebration Bundle at store.auroramc.net to unlock this Gadget!", true, Material.FIREWORK, (short)0, Rarity.LEGENDARY, 5);
    }
