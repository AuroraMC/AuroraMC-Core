...
public class FireworkTrail extends ProjectileTrail {
    public FireworkTrail() {
        super(1000, AuroraMCAPI.getFormatter().rainbowBold("Firework Trail"), AuroraMCAPI.getFormatter().rainbowBold("Firework Trail"), "A trail of fireworks. This one is loud. Sorry.", UnlockMode.STORE_PURCHASE, -1, Collections.emptyList(), Collections.emptyList(), "Purchase the Grand Celebration Bundle at store.auroramc.net to unlock this Death Effect!", true, Material.FIREWORK, (short)0, Rarity.COMMON);
    }
