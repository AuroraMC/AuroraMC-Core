...
public class Eggsplosion extends WinEffect {
    ...
    public Eggsplosion() {
        super(602, "EGGsplosion", "&7&lEGGsplosion", "What an EGGcelent end to a game!", UnlockMode.STORE_PURCHASE, -1, Collections.emptyList(), Collections.emptyList(),"Purchase the AuroraMC Starter Pack at store.auroramc.net to unlock this Win Effect!", true, Material.EGG, (short)0, Rarity.RARE);
    }
