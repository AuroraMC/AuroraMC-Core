...
public class BusyHavingALife extends FriendStatus {
    ...
    public BusyHavingALife() {
        super(120, "&aBusy having a life", "&aBusy having a life", UnlockMode.CRATE, -1, Collections.emptyList(), Collections.emptyList(), "Found in Crates", "&a&lBusy having a life", 'a', true);
    }
}
