...
public class LiveStreaming extends FriendStatus {
    ...
    public LiveStreaming() {
        super(108, "Live Streaming", "Live Streaming", UnlockMode.PERMISSION, -1, Collections.singletonList(Permission.SOCIAL), Collections.emptyList(), "", "Live Streaming", '5', false);
    }
}
