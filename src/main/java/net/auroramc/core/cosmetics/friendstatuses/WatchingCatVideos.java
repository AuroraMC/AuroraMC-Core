...
public class WatchingCatVideos extends FriendStatus {
    public WatchingCatVideos() {
        super(122, "&dWatching Cat Videos", "&dWatching Cat Videos", UnlockMode.CRATE, -1, Collections.emptyList(), Collections.emptyList(), "Found in Crates", "&d&lWatching Cat Videos", 'd', true);
    }
}
