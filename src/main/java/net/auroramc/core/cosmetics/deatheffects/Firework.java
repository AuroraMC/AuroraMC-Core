...
public class Firework extends DeathEffect {
    ...
    public Firework() {
        super(700, "Firework", AuroraMCAPI.getFormatter().rainbow("Firework"), "Some description.", UnlockMode.STORE_PURCHASE, -1, Collections.emptyList(), Collections.emptyList(), "Purchase the Grand Celebration Bundle at store.auroramc.net to unlock this Death Effect!", true, Material.FIREWORK, (short)0, Rarity.COMMON);
    }
