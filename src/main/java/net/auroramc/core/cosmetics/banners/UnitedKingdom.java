...
public class UnitedKingdom extends Banner {
    ...
    public UnitedKingdom() {
        super(0, "United Kingdom Flag", "&c&lUnited Kingdom Flag", "&c&lRULE BRITANIA!", UnlockMode.ALL, -1, new ArrayList<>(), new ArrayList<>(), "Found in Crates", patterns, DyeColor.BLUE, true);
    }
}
