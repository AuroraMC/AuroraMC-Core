...
public class Ogre extends Banner {
    ...
    public Ogre() {
        super(18, "Ogre", "&2&lOgre", "&2He's gonna get you!", UnlockMode.SPECIAL_CRATE, -1, new ArrayList<>(), new ArrayList<>(), "Found in Crates", patterns, DyeColor.BLACK, true, Rarity.RARE);
    }
}
