...
public class JackOLantern extends Banner {
    ...
    public JackOLantern() {
        super(12, "Jack-O-Lantern", "&6&lJack-O&8&l-Lantern", "&8Watch out for ghosts and ghouls!", UnlockMode.ALL, -1, new ArrayList<>(), new ArrayList<>(), "Found in Spooky Crates", patterns, DyeColor.ORANGE, true);
    }
}
