...
public class CandyCane extends Banner {
    ...
    public CandyCane() {
        super(16, "Candy Cane", "&c&lCandy&r &f&lCane", "&cMmmm tasty...", UnlockMode.SPECIAL_CRATE, -1, new ArrayList<>(), new ArrayList<>(), "Found in Candy Crates", patterns, DyeColor.RED, true, Rarity.RARE);
    }
}
