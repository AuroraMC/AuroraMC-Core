...
public class Germany extends Banner {
    ...
    public Germany() {
        super(4, "Germany", "&c&lGermany", "There is currently no description for this cosmetic!", UnlockMode.CRATE, -1, Collections.emptyList(), Collections.emptyList(), "Found in Crates", patterns, DyeColor.RED, true);
    }
}
