...
public class AuroraMC extends Banner {
    ...
    public AuroraMC() {
        super(3, "AuroraMC?", "&3&lAuroraMC?", "&3It's the best we could do, okay?", UnlockMode.ALL, 100, new ArrayList<>(), new ArrayList<>(), "Found in Crates", patterns, DyeColor.WHITE, true);
    }
}
