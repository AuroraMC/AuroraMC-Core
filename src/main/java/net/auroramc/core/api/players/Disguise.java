...
public class Disguise {
    ...
    private static final String[] NOUNS = {"Wheat","Phone","Honey","Tractor","Apple","Bird","Bread","Cookie","Mixer","Button","Donkey","Horse","Mouse","Candy","Avacado","Goose","Kitty","Cat","Dog","Doggy","Biscuit","Gravy","Potato","Console","Mole","Rabbit","Bun","Bunny","Face","Cheddar","Highway","Clothes","Freedom","Bird","Extend","Data","Speech","Bath","Chapter","Failure","Heart","News","Month","Lab","Salad","Library","Airport","Basis","Error","Null","Analyst","Basket","Sport","Law"};
