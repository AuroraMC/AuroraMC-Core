...
public class RecruitmentLookup extends GUI {
    ...
    public RecruitmentLookup(String name, PunishmentHistory history, PlayerStatistics statistics, IPLookup ipprofile) {
        ...
        boolean requirementMetPunishments = (((!lightActive) && (light == -1 || System.currentTimeMillis() > light + 2592000000L)) && ((!mediumActive) && (medium == -1 || System.currentTimeMillis() > medium + 2592000000L)) && ((!heavyActive) && (heavy == -1 || System.currentTimeMillis() > heavy + 2592000000L)) && ((!severeActive) && (light == -1 || System.currentTimeMillis() > light + 2592000000L)) && ((!extremeActive) && (extreme == -1 || System.currentTimeMillis() > extreme + 2592000000L)));
