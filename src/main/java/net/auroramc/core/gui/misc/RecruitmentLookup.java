...
public class RecruitmentLookup extends GUI {
    ...
    public RecruitmentLookup(String name, PunishmentHistory history, PlayerStatistics statistics, PlayerProfile ipprofile) {
        ...
        this.setItem(1, 2, new GUIItem(Material.WATCH, "&3&lIn-Game Time", 1, String.format(";&r&fRequirement met? %s;&r&fTotal In-game Time: **%s**", ((statistics.getLobbyTimeMs() + statistics.getGameTimeMs() >= 36000000)?"&a✔":"&c✘"), (new TimeLength((statistics.getGameTimeMs() + statistics.getLobbyTimeMs())/3600000d, false)))));
