...
public class IPLookupProfile extends GUI {
    ...
    public IPLookupProfile(IPProfile playerProfile) {
        ...
        this.setItem(1, 3, new GUIItem(Material.BOOK, "&3&lAccounts", 1, String.format(";&rThis IP Profile is;&rshared with **%s** other accounts.;;&rMost recent alts:;**%s**", playerProfile.getNumberOfAccounts(), String.join("**;**", playerProfile.getAccounts()))));
