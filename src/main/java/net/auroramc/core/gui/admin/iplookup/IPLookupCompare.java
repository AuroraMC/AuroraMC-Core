...
public class IPLookupCompare extends GUI {
    ...
    public IPLookupCompare(ProfileComparison playerProfile) {
        ...
        this.setItem(2, 3, new GUIItem(Material.BOOK_AND_QUILL, "&3&lAlternate Accounts", 1, String.format(";&rThese users have;&rs**%s** alt accounts in common.;;Most recent common alts:;**%s**", playerProfile.getAmountOfCommonAlts(), String.join("**;**", playerProfile.getCommonAlts()))));
