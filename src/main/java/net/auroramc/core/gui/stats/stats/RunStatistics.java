...
public class RunStatistics extends GUI {
    ...
    public RunStatistics(AuroraMCPlayer player, String targetName, PlayerStatistics targetStatistics, PlusSubscription subscription, int playerId) {
        ...
        this.setItem(2, 6, new GUIItem(Material.STAINED_CLAY, "&b&lKit Statistics", 1, ";&3&lRunKit;&rLevel: **" + hotPotatoLevel.getLevel() + "**;&rTotal XP: **" + String.format("%,d", hotPotatoLevel.getTotalXpEarned()) + "**;&rCurrent Upgrade: **" + hotPotatoLevel.getLatestUpgrade() + "**", (short)14));
