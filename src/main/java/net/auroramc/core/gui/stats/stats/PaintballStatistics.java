...
public class PaintballStatistics extends GUI {
    ...
    public PaintballStatistics(AuroraMCPlayer player, String targetName, PlayerStatistics targetStatistics, PlusSubscription subscription, int playerId) {
        ...
        this.setItem(2, 2, new GUIItem(Material.SNOW_BALL, "&b&lGame Statistics", 1, "&7Your top items brought!;;&rExtra Lives: **" + targetStatistics.getStatistic(3, "extraLives") + "**;&rMore Ammo!: **" + targetStatistics.getStatistic(3, "extraAmmo") + "**;&rFlashbang: **" + targetStatistics.getStatistic(3, "flashbang")  + "**;&rTurret: **" + targetStatistics.getStatistic(3, "turret")  + "**"));
        ...
        this.setItem(2, 4, new GUIItem(Material.SNOW_BALL, "&b&lGame Statistics", 1, ";&rGames Played: **" + targetStatistics.getStatistic(3, "gamesPlayed") + "**;&rWins: **" + targetStatistics.getStatistic(3, "gamesWon") + "**;&rLosses: **" + losses + "**;&rWin/Loss Ratio: **" + finalWlr + "**;;&rCrowns Earned: **" + String.format("%,d", targetStatistics.getStatistic(3, "crownsEarned"))  + "**;&rTickets Earned: **" + String.format("%,d", targetStatistics.getStatistic(3, "ticketsEarned")) + "**;&rExperience Earned: **" + String.format("%,d", targetStatistics.getStatistic(3, "xpEarned")) + "**;;&rKills: **" + targetStatistics.getStatistic(3, "kills") + "**;&rDeaths: **" + targetStatistics.getStatistic(3, "deaths") + "**;&rKill/Death Ratio: **" + finalKdr + "**"));
        ...
        this.setItem(3, 4, new GUIItem(Material.BOOK, "&bTag Achievements", 1, String.format("&rAchieved: **%s**;&rTotal Achievements: **%s**;;&aClick to view more!", player.getStats().getAchievementsGained().keySet().stream().filter(achievement -> achievement.getCategory() == Achievement.AchievementCategory.GAME && achievement.getGameId() == 3).count(), totalGameAchievements)));
    }
