...
public class TagStatistics extends GUI {
    ...
    public TagStatistics(AuroraMCPlayer player, String targetName, PlayerStatistics targetStatistics, PlusSubscription subscription, int playerId) {
        ...
        this.setItem(2, 2, new GUIItem(Material.LEASH, "&b&lGame Statistics", 1, ";&r&fPeople Tagged: **" + targetStatistics.getStatistic(103, "tags") + "**;&r&fGot Tagged: **" + targetStatistics.getStatistic(103, "tagged") + "**;&r&fTag/Tagged Ratio: **" + finalKdr + "**"));
