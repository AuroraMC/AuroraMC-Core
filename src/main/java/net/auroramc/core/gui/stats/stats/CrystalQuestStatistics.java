...
public class CrystalQuestStatistics extends GUI {
    ...
    public CrystalQuestStatistics(AuroraMCPlayer player, String targetName, PlayerStatistics targetStatistics, PlusSubscription subscription, int playerId) {
        ...
        this.setItem(2, 4, new GUIItem(Material.NETHER_STAR, "&b&lGame Statistics", 1, ";&rGames Played: **" + targetStatistics.getStatistic(1, "gamesPlayed") + "**;&rWins: **" + targetStatistics.getStatistic(1, "gamesWon") + "**;&rLosses: **" + losses + "**;&rWin/Loss Ratio: **" + ((losses == 0)?targetStatistics.getStatistic(1, "gamesWon"):targetStatistics.getStatistic(1, "gamesWon")/losses) + "**;;&rCrowns Earned: **" + targetStatistics.getStatistic(1, "crownsEarned") + "**;&rTickets Earned: **" + targetStatistics.getStatistic(1, "ticketsEarned") + "**;&rExperience Earned: **" + targetStatistics.getStatistic(1, "xpEarned") + "**;;&rKills: **" + targetStatistics.getStatistic(1, "kills") + "**;&rDeaths: **" + targetStatistics.getStatistic(1, "deaths") + "**;&rKill/Death Ratio: **" + ((targetStatistics.getStatistic(1, "deaths") == 0)?targetStatistics.getStatistic(1, "kills"):targetStatistics.getStatistic(1, "kills") / targetStatistics.getStatistic(1, "deaths")) + "**"));
