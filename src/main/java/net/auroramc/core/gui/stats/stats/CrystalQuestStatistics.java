...
public class CrystalQuestStatistics extends GUI {
    ...
    public CrystalQuestStatistics(AuroraMCPlayer player, String targetName, PlayerStatistics targetStatistics, PlusSubscription subscription, int playerId) {
        ...
        this.setItem(2, 4, new GUIItem(Material.NETHER_STAR, "&b&lGame Statistics", 1, ";&rGames Played: **" + targetStatistics.getStatistic(1, "gamesPlayed") + "**;&rWins: **" + targetStatistics.getStatistic(1, "gamesWon") + "**;&rLosses: **" + losses + "**;&rWin/Loss Ratio: **" + finalWlr + "**;;&rCrowns Earned: **" + String.format("%,d", targetStatistics.getStatistic(1, "crownsEarned"))  + "**;&rTickets Earned: **" + String.format("%,d", targetStatistics.getStatistic(1, "ticketsEarned")) + "**;&rExperience Earned: **" + String.format("%,d", targetStatistics.getStatistic(1, "xpEarned")) + "**;;&rKills: **" + targetStatistics.getStatistic(1, "kills") + "**;&rDeaths: **" + targetStatistics.getStatistic(1, "deaths") + "**;&rKill/Death Ratio: **" + finalKdr + "**"));
        ...
        this.setItem(2, 6, new GUIItem(Material.NETHER_STAR, "&b&lKit Statistics", 1, ";&3&lMiner Kit;&rLevel: **" + minerLevel.getLevel() + "**;&rTotal XP: **" + String.format("%,d", minerLevel.getTotalXpEarned()) + "**;&rCurrent Upgrade: **" + minerLevel.getLatestUpgrade() + "**;;&3&lDefender Kit;&rLevel: **" + defenderLevel.getLevel() + "**;&rTotal XP: **" + String.format("%,d", defenderLevel.getTotalXpEarned()) + "**;&rCurrent Upgrade: **" + minerLevel.getLatestUpgrade() + "**;;&3&lFighter Kit;&rLevel: **" + fighterLevel.getLevel() + "**;&rTotal XP: **" + String.format("%,d", fighterLevel.getTotalXpEarned()) + "**;&rCurrent Upgrade: **" + fighterLevel.getLatestUpgrade() + "**"));
