...
public class IPLookupCompare extends GUI {
    ...
    public IPLookupCompare(ProfileComparison playerProfile) {
        ...
        this.setItem(1, 3, new GUIItem(Material.PLAYER_HEAD, playerProfile.getFirstUser(), 1, "", (short)0, false, playerProfile.getFirstUser()));
        this.setItem(1, 4, new GUIItem(Material.COMPARATOR, "&3&lComparing IP Profiles"));
        this.setItem(1, 5, new GUIItem(Material.PLAYER_HEAD, playerProfile.getSecondUser(), 1, "", (short)0, false, playerProfile.getSecondUser()));

        this.setItem(2, 3, new GUIItem(Material.WRITABLE_BOOK, "&3&lAlternate Accounts", 1, String.format(";&r&fThese users have;&r&f**%s** alt accounts in common.;;&r&fMost recent common alts:;**%s**", playerProfile.getAmountOfCommonAlts(), String.join("**;**", playerProfile.getCommonAlts()))));
