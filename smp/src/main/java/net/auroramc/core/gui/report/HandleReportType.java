...
public class HandleReportType extends GUI {
    ...
    public HandleReportType(AuroraMCServerPlayer player) {
        ...
        this.setItem(1, column, new GUIItem(Material.WRITABLE_BOOK, "&3&lChat Report", 1, ";&r&fClick here to handle a chat report."));
        this.setItem(1, column + 2, new GUIItem(Material.OAK_SIGN, "&3&lMisc Report", 1, ";&r&fClick here to handle a misc report."));
