...
public class PunishmentHistoryGUI extends GUI {
    ...
    public PunishmentHistoryGUI(AuroraMCServerPlayer player, int id, String name, String removalReason1, UUID uuid) {
        ...
        this.setItem(0, 4, new GUIItem(Material.PLAYER_HEAD, String.format("&3&l%s's Punishment History", name), 1, "&r&fPunishment History", (short) 0, false, name));
        ...
        for (Punishment punishment : punishments) {
            if (punishment.getStatus() != 4) {
                ...
                if (punishment.getStatus() == 7) {
                    ...
                    switch (rule.getType()) {
                        case 1:
                            this.setItem(row, column, new GUIItem(Material.WRITABLE_BOOK, "&3&lChat Offence", 1, lore, (short) 0, ((punishment.getStatus() == 1 || punishment.getStatus() == 2 || punishment.getStatus() == 3) && (punishment.getExpire() > System.currentTimeMillis() || punishment.getExpire() == -1))));
                            break;
                        case 2:
                            ...
                            break;
                        case 3:
                            this.setItem(row, column, new GUIItem(Material.OAK_SIGN, "&3&lMisc Offence", 1, lore, (short) 0, ((punishment.getStatus() == 1 || punishment.getStatus() == 2 || punishment.getStatus() == 3) && (punishment.getExpire() > System.currentTimeMillis() || punishment.getExpire() == -1))));
                            break;
                    }
    ...
    public void onClick(int row, int column, ItemStack item, ClickType clickType) {
        if (item.getType() == Material.ARROW) {
            ...
            if (column == 1) {
                ...
                if (currentPage == 1) {
                    this.updateItem(5, 1, new GUIItem(Material.GRAY_STAINED_GLASS_PANE, String.format("&3&l%s's Punishment History", this.name), 1, ""));
                }
            } else {
                //next page.
                currentPage++;
                if (punishments.size() < ((currentPage) * 28)) {
                    this.updateItem(5, 7, new GUIItem(Material.GRAY_STAINED_GLASS_PANE, String.format("&3&l%s's Punishment History", this.name), 1, ""));
                }
            ...
            for (int i = 0;i < 28;i++) {
                ...
                if (punishment.getStatus() != 4) {
                    ...
                    if (punishment.getStatus() == 7) {
                        ...
                        switch (rule.getType()) {
                            case 1:
                                this.updateItem(row, column, new GUIItem(Material.WRITABLE_BOOK, "&3&lChat Offence", 1, lore, (short) 0, ((punishment.getStatus() == 1 || punishment.getStatus() == 2 || punishment.getStatus() == 3) && (punishment.getExpire() > System.currentTimeMillis() || punishment.getExpire() == -1))));
                                break;
                            case 2:
                                ...
                                break;
                            case 3:
                                this.updateItem(row, column, new GUIItem(Material.OAK_SIGN, "&3&lMisc Offence", 1, lore, (short) 0, ((punishment.getStatus() == 1 || punishment.getStatus() == 2 || punishment.getStatus() == 3) && (punishment.getExpire() > System.currentTimeMillis() || punishment.getExpire() == -1))));
                                break;
                        }
            ...
            return;
        } else if (item.getType() == Material.GRAY_STAINED_GLASS_PANE || item.getType() == Material.PLAYER_HEAD) {
