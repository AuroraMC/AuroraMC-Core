...
public class Stats extends GUI {
    ...
    public Stats(AuroraMCServerPlayer player, String targetName, PlayerStatistics targetStatistics, PlusSubscription subscription, int playerId) {
        ...
        this.setItem(0, 4, new GUIItem(Material.PLAYER_HEAD, String.format("&3&l%s's Statistics", name), 1, "", (short) 3, false, name));
        ...
        this.setItem(0, 6, new GUIItem(Material.FIREWORK_ROCKET, "&3&lView Achievements", 1, String.format(";&r&fAchieved: **%s**;&r&fTotal Achievements: **%s**;;&aClick to view more!", targetStatistics.getAchievementsGained().size(), totalAchievements)));
        ...
        this.setItem(2, 4, new GUIItem(Material.SNOWBALL, "&a&lPaintball", 1, ";&r&fGames Played: **" + targetStatistics.getStatistic(3, "gamesPlayed") + "**;&r&fWins: **" + targetStatistics.getStatistic(3, "gamesWon") + "**;&r&fLosses: **" + (targetStatistics.getStatistic(3, "gamesPlayed") - targetStatistics.getStatistic(3, "gamesWon")) + "**;;&aClick to view more!"));
        this.setItem(2, 5, new GUIItem(Material.IRON_SHOVEL, "&b&lSpleef", 1, ";&r&fGames Played: **" + targetStatistics.getStatistic(100, "gamesPlayed") + "**;&r&fWins: **" + targetStatistics.getStatistic(100, "gamesWon") + "**;&r&fLosses: **" + (targetStatistics.getStatistic(100, "gamesPlayed") - targetStatistics.getStatistic(100, "gamesWon")) + "**;;&aClick to view more!"));
        this.setItem(2, 6, new GUIItem(Material.BAKED_POTATO, "&c&lHot Potato", 1, ";&r&fGames Played: **" + targetStatistics.getStatistic(101, "gamesPlayed") + "**;&r&fWins: **" + targetStatistics.getStatistic(101, "gamesWon") + "**;&r&fLosses: **" + (targetStatistics.getStatistic(101, "gamesPlayed") - targetStatistics.getStatistic(101, "gamesWon")) + "**;;&aClick to view more!"));
        ...
        this.setItem(3, 4, new GUIItem(Material.LEAD, "&c&lTag", 1, ";&r&fGames Played: **" + targetStatistics.getStatistic(103, "gamesPlayed") + "**;&r&fWins: **" + targetStatistics.getStatistic(103, "gamesWon") + "**;&r&fLosses: **" + (targetStatistics.getStatistic(103, "gamesPlayed") - targetStatistics.getStatistic(103, "gamesWon")) + "**;;&aClick to view more!"));
        this.setItem(3, 5, new GUIItem(Material.RED_CONCRETE, "&e&lRun", 1, ";&r&fGames Played: **" + targetStatistics.getStatistic(104, "gamesPlayed") + "**;&r&fWins: **" + targetStatistics.getStatistic(104, "gamesWon") + "**;&r&fLosses: **" + (targetStatistics.getStatistic(104, "gamesPlayed") - targetStatistics.getStatistic(104, "gamesWon")) + "**;;&aClick to view more!"));
