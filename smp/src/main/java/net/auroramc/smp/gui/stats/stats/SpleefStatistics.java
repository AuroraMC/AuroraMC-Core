...
public class SpleefStatistics extends GUI {
    ...
    public SpleefStatistics(AuroraMCServerPlayer player, String targetName, PlayerStatistics targetStatistics, PlusSubscription subscription, int playerId) {
        ...
        this.setItem(2, 2, new GUIItem(Material.IRON_SHOVEL, "&b&lGame Statistics", 1, ";&r&fBlocks Broken: **" + targetStatistics.getStatistic(100, "blocksBroken") + "**;&r&fSnowballs Thrown: **" + targetStatistics.getStatistic(100, "snowballsThrown") + "**"));
