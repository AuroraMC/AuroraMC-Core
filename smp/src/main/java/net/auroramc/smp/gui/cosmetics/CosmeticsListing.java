...
import net.auroramc.smp.api.events.cosmetics.CosmeticDisableEvent;
import net.auroramc.smp.api.events.cosmetics.CosmeticEnableEvent;
import net.auroramc.smp.api.events.cosmetics.CosmeticSwitchEvent;
