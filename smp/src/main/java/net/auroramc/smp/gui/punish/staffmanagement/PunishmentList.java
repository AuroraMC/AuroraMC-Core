...
package net.auroramc.smp.gui.punish.staffmanagement;
...
public class PunishmentList extends GUI {
    ...
    public PunishmentList(AuroraMCServerPlayer player, List<Mentor> mentors, Mentor clickedMentor, Mentee clickedMentee, List<Punishment> punishments) {
        ...
        this.setItem(0, 4, new GUIItem(Material.PLAYER_HEAD, ((clickedMentee != null)?String.format("&3&l%s's Pending Punishments", clickedMentee.getName()):"&3&lUnassigned Pending Punishments"), 1, "&r&fPending Punishments", (short) 0, false, ((clickedMentee==null)?null:clickedMentee.getName())));
        ...
        for (Punishment punishment : punishments) {
            ...
            switch (rule.getType()) {
                case 1:
                    this.setItem(row, column, new GUIItem(Material.WRITABLE_BOOK, "&3&lChat Offence", 1, lore));
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    this.setItem(row, column, new GUIItem(Material.OAK_SIGN, "&3&lMisc Offence", 1, lore));
                    break;
            }
    ...
    public void onClick(int row, int column, ItemStack item, ClickType clickType) {
        ...
        if (item.getType() == Material.ARROW) {
            ...
            if (column == 1) {
                ...
                if (currentPage == 1) {
                    this.updateItem(5, 1, new GUIItem(Material.GRAY_STAINED_GLASS_PANE, ((clickedMentee != null)?String.format("&3&l%s's Pending Punishments", clickedMentee.getName()):"&3&lUnassigned Pending Punishments"), 1, "", (short) 7));
                }
            } else {
                //next page.
                currentPage++;
                if (punishments.size() < ((currentPage) * 28)) {
                    this.updateItem(5, 7, new GUIItem(Material.GRAY_STAINED_GLASS_PANE, ((clickedMentee != null)?String.format("&3&l%s's Pending Punishments", clickedMentee.getName()):"&3&lUnassigned Pending Punishments"), 1, "", (short) 7));
                }
