...
package net.auroramc.smp.gui.friends;
...
public class Friends extends GUI {
    ...
    public Friends(AuroraMCServerPlayer player) {
        ...
        this.setItem(5, 5, new GUIItem(((friendsList.getVisibilityMode() == ALL) ? Material.LIME_DYE : ((friendsList.getVisibilityMode() == FAVOURITE_FRIENDS_ONLY) ? Material.ORANGE_DYE : Material.GRAY_DYE)), "&3&lServer Visibility", 1, String.format(";&r&fCurrent Server Visibility: %s;;&r&fClick to change to: %s", ((friendsList.getVisibilityMode() == ALL) ? "&aAll" : ((friendsList.getVisibilityMode() == FAVOURITE_FRIENDS_ONLY) ? "&6Favourite Friends Only" : "&cNobody")), ((friendsList.getVisibilityMode() == ALL) ? "&6Favourite Friends Only" : ((friendsList.getVisibilityMode() == FAVOURITE_FRIENDS_ONLY) ? "&cNobody" : "&aAll")))));
            ...
            if (row == 0 || row == 5) {
                switch (item.getType()) {
                    case NETHER_STAR:
                        ...
                        refresh();
                        currentPage = 1;
                        this.updateItem(5, 1, new GUIItem(Material.GRAY_STAINED_GLASS_PANE, "&3&lYour Friends", 1, "", (short) 7));
                        if (displayOrder.size() > 28) {
                        ...
                        if (column == 7) {
                            ...
                            if (view == FriendsView.STATUS) {
                                if (statuses.size() < ((currentPage) * 28)) {
                                    this.updateItem(5, 7, new GUIItem(Material.GRAY_STAINED_GLASS_PANE, "&3&lYour Friends", 1, "", (short) 7));
                                }
                            } else {
                    ...
                    case LIME_DYE:
                        ...
                        this.updateItem(5, 5, new GUIItem(((friendsList.getVisibilityMode() == ALL) ? Material.LIME_DYE : ((friendsList.getVisibilityMode() == FAVOURITE_FRIENDS_ONLY) ? Material.ORANGE_DYE : Material.GRAY_DYE)), "&3&lServer Visibility", 1, String.format(";&r&fCurrent Server Visibility: %s;;&r&fClick to change to: %s", ((friendsList.getVisibilityMode() == ALL) ? "&aAll" : ((friendsList.getVisibilityMode() == FAVOURITE_FRIENDS_ONLY) ? "&6Favourite Friends Only" : "&cNobody")), ((friendsList.getVisibilityMode() == ALL) ? "&6Favourite Friends Only" : ((friendsList.getVisibilityMode() == FAVOURITE_FRIENDS_ONLY) ? "&cNobody" : "&aAll")))));
                        break;
                    case NAME_TAG:
                ...
                for (int i = 0; i < 28; i++) {
                    ...
                    if (view == FriendsView.STATUS) {
                        ...
                        if (view == FriendsView.REQUESTS) {
                            this.updateItem(row, column, new GUIItem(((friend.getType() == Friend.FriendType.PENDING_INCOMING) ? Material.ENDER_PEARL : Material.ENDER_EYE), String.format("&3&l%s", friend.getName()), 1, ((friend.getType() == Friend.FriendType.PENDING_INCOMING) ? String.format("&r&fIncoming request from **%s**.;;&r&aLeft-Click to accept.;&r&cRight-Click to deny.", friend.getName()) : String.format("&r&fOutgoing request to **%s**;;&r&cShift-Right-Click to revoke.", friend.getName()))));
                        } else {
                            if (view == FriendsView.DELETE) {
                                this.updateItem(row, column, new GUIItem(((!friend.getStatus().equals(AuroraMCAPI.getCosmetics().get(101))) ? Material.PLAYER_HEAD : Material.SKELETON_SKULL), String.format("&3&l%s&r&b%s", friend.getName(), ((friend.getType() == Friend.FriendType.FAVOURITE) ? " ✰" : "")), 1, String.format(";&r&fStatus: &%s%s%s;;&r&cLeft-Click to remove them as a friend.", friend.getStatus().getColour(), friend.getStatus().getName(), ((friend.getServer() != null) ? String.format(";&r&fServer: **%s**", friend.getServer()) : "")), (short)0, false, friend.getName()));
                            } else {
                                this.updateItem(row, column, new GUIItem(((!friend.getStatus().equals(AuroraMCAPI.getCosmetics().get(101))) ? Material.PLAYER_HEAD : Material.SKELETON_SKULL), String.format("&3&l%s&r&b%s", friend.getName(), ((friend.getType() == Friend.FriendType.FAVOURITE) ? " ✰" : "")), 1, String.format(";&r&fStatus: &%s%s%s;;&r&f&%sShift-Left-Click to %s them as a favourite friend.", friend.getStatus().getColour(), friend.getStatus().getName(), ((friend.getServer() != null) ? String.format(";&r&fServer: **%s**", friend.getServer()) : ""), ((friend.getType() == Friend.FriendType.FAVOURITE) ? 'c' : 'a'), ((friend.getType() == Friend.FriendType.FAVOURITE) ? "remove" : "add")), (short)0, false, friend.getName()));
                            }
                        }
                    ...
                    switch (view) {
                        ...
                        case DELETE:
                            ...
                            for (int i = 0; i < 28; i++) {
                                ...
                                this.updateItem(row, column, new GUIItem(((!friend.getStatus().equals(AuroraMCAPI.getCosmetics().get(101))) ? Material.PLAYER_HEAD : Material.SKELETON_SKULL), String.format("&3&l%s", friend.getName()), 1, String.format(";&r&fStatus: &%s%s%s;;&r&cLeft-Click to remove them as a friend.", friend.getStatus().getColour(), friend.getStatus().getName(), ((friend.getServer() != null) ? String.format(";&r&fServer: **%s**", friend.getServer()) : "")), ((!friend.getStatus().equals(AuroraMCAPI.getCosmetics().get(101))) ? (short) 3 : (short) 0), false, friend.getName()));
                                column++;
                                if (column == 8) {
                                    row++;
                                    column = 1;
