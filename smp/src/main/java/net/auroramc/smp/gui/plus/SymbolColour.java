...
public class SymbolColour extends GUI {
    ...
    public SymbolColour(AuroraMCServerPlayer player) {
        ...
        this.setItem(0, 4, new GUIItem(Material.PLAYER_HEAD, "&3&lYour Plus Colour", 1, String.format("&r&fCurrent Plus Colour: %s%s", player.getActiveSubscription().getSuffixColor(), WordUtils.capitalizeFully(player.getActiveSubscription().getSuffixColor().name().replace("_", " ").toLowerCase())), (short) 0, false));
