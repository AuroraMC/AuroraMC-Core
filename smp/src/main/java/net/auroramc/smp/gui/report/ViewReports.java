...
public class ViewReports extends GUI {
    ...
    public ViewReports(AuroraMCServerPlayer player, List<PlayerReport> reports, String target) {
        ...
        this.setItem(0, 4, new GUIItem(Material.PLAYER_HEAD, "&3&l" + ((target != null)?target + "'s ":"") + " Recent Reports", 1, ";&r&fView all recent reports " + ((target != null)?target + " has":"you've") +" submitted.", (short)0, false, target));
        ...
        for (PlayerReport report : reports) {
            Material item = Material.WRITABLE_BOOK;
    ...
    public void onClick(int row, int column, ItemStack item, ClickType clickType) {
        if (item.getType() == Material.ARROW) {
            ...
            if (column == 1) {
                ...
                if (currentPage == 1) {
                    this.updateItem(5, 1, new GUIItem(Material.GRAY_STAINED_GLASS_PANE, "&3&lYour Reports", 1, "", (short) 7));
                }
            } else {
                //next page.
                currentPage++;
                if (reports.size() < ((currentPage) * 28)) {
                    this.updateItem(5, 7, new GUIItem(Material.GRAY_STAINED_GLASS, "&3&lYour Reports", 1, "", (short) 7));
                }
            ...
            for (int i = 0;i < 28;i++) {
                ...
                Material guiitem = Material.WRITABLE_BOOK;
                String name = "&3&lChat Report";
                switch (report.getType()) {
                    case HACKING:
