...
import net.auroramc.smp.api.events.player.PlayerPreferenceChangeEvent;
import net.auroramc.smp.api.player.AuroraMCServerPlayer;
import net.auroramc.smp.api.utils.ServerDisguise;
...
public class ServerAbstractedMethods extends AbstractedMethods {
    ...
    public void onEquipBanner(AuroraMCPlayer player, Banner banner) {
        ItemStack item = new ItemStack(Material.valueOf(banner.getBase() + "_BANNER"), 1);
